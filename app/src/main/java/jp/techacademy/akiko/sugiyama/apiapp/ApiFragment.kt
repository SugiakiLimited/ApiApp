...
class ApiFragment: Fragment() {
    ...
    private var page = 0
    // Apiでデータを読み込み中ですフラグ。追加ページの読み込みの時にこれがないと連続して読み込んでしまうので、それの制御のため
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        return inflater.inflate(R.layout.fragment_api, container, false) // fragment_api.xmlが反映されたViewを作成してreturnします
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerView.apply {
            ...
            addOnScrollListener(object: RecyclerView.OnScrollListener(){ // Scrollを検知するListenerを実装する。これによってRecyclerViewの下端に近づいた時に次のページを読み込んで下に付け足す
    ...
    private fun updateData(isAdd: Boolean = false) {
        ...
        val url = StringBuilder()
            ...
            .append("&format=json") // ここで利用しているAPIは戻りの形をxmlかjsonが選択することができる。Androidで扱う場合はxmlよりもjsonの方が扱いやすいのでjsonを選択
            .toString()
